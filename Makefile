...
vol2vol: lib/vol_basis.o lib/vol_geom.o lib/vol_av.o \
    thirdparty/basis_universal/basisu_transcoder.o thirdparty/basis_universal/zstd.o \
    thirdparty/basis_universal/basisu_enc.o thirdparty/basis_universal/basisu_comp.o \
    thirdparty/basis_universal/basisu_resampler.o thirdparty/basis_universal/basisu_resample_filters.o \
    thirdparty/basis_universal/basisu_backend.o thirdparty/basis_universal/basisu_frontend.o \
    thirdparty/basis_universal/basisu_basis_file.o thirdparty/basis_universal/basisu_etc.o \
    thirdparty/basis_universal/basisu_bc7enc.o thirdparty/basis_universal/basisu_uastc_enc.o \
    thirdparty/basis_universal/basisu_kernels_sse.o thirdparty/basis_universal/basisu_opencl.o \
    thirdparty/basis_universal/basisu_gpu_texture.o thirdparty/basis_universal/basisu_ssim.o \
    thirdparty/basis_universal/basisu_pvrtc1_4.o thirdparty/basis_universal/jpgd.o \
    thirdparty/basis_universal/pvpngreader.o
	...
	$(CPP) $(FLAGSCPP) $(FLAGS) $(DEBUG) $(SANS) -o vol2vol$(BIN_EXT) \
    tools/vol2vol/vol2vol.o tools/vol2vol/video_processing.o tools/vol2vol/basis_encoder_wrapper.o \
    lib/vol_av.o lib/vol_basis.o lib/vol_geom.o \
    thirdparty/basis_universal/basisu_transcoder.o thirdparty/basis_universal/zstd.o \
    thirdparty/basis_universal/basisu_enc.o thirdparty/basis_universal/basisu_comp.o \
    thirdparty/basis_universal/basisu_resampler.o thirdparty/basis_universal/basisu_resample_filters.o \
    thirdparty/basis_universal/basisu_backend.o thirdparty/basis_universal/basisu_frontend.o \
    ...
    thirdparty/basis_universal/basisu_pvrtc1_4.o thirdparty/basis_universal/jpgd.o \
    thirdparty/basis_universal/pvpngreader.o \
    $(INC_DIR) $(STA_LIB_AV) $(LIB_DIR) $(DYN_LIB_AV) $(DYN_LIB_OPENCL)
